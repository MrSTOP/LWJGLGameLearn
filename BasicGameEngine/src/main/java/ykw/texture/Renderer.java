...
public class Renderer {
    ...
    public void init(Window window) throws Exception {
        ...
        shaderProgram.createVertexShader(Utils.loadResource("/shader/texturetest/vertex.vert"));
        shaderProgram.createFragmentShader(Utils.loadResource("/shader/texturetest/fragment.frag"));
        shaderProgram.link();
